...
|-------------|:-----------------:|------------------------------:|
| POST        |  /products        |   Criação de um produto       | - OK
| PUT         |  /products/{id}   |   Atualização de um produto   | - OK
| GET         |  /products/{id}   |   Busca de um produto por ID  | - OK
| GET         |  /products        |   Lista de produtos           | - OK
| GET         |  /products/search |   Lista de produtos filtrados | - ?
| DELETE      |  /products/{id}   |   Deleção de um produto       | - OK
